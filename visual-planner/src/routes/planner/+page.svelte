<script lang="ts">
  ...
  onMount(() => {
    ...
    // @ts-expect-error – gapi injected via CDN script tag in app.html
...
>
  ...
  <header class="banner">
    <div class="banner-left">
      {#if uiView === 'planner'}
        ...
        ><span class="material-icons">view_column</span></button>
        ...
        ><span class="material-icons">calendar_view_day</span></button>
            ...
            <div class="vpdays">
              {#each month.days as day (day.index)}
                <div
                  ...
                  style={Object.entries(day.labelboxstyle).map(([k, v]) => `${k}:${v}`).join(';')}
                >
                  <!-- Day number -->
                  <span
                    class="vpday-num"
                    ...
                    onkeydown={(e) => e.key === 'Enter' && day.onclickNum(e as unknown as MouseEvent)}
                  >{day.num}</span>
                  ...
                  {#if day.labels}
                    {#each day.labels as label (label)}
                      <div
                        ...
                        style={Object.entries(label.style).map(([k, v]) => `${k}:${v}`).join(';')}
  ...
  ============================================================ -->
  {#if uiView === 'settings'}
    <SettingsView markDirty={markDirty} appdata={appdata} permissions={permissions} />
{/if}
</div>
